...
<Steps>
  ...
  <Step title="Basic Settings" titleSize="h2">
    ...
    <Frame caption="Basic Settings - ermbot.xyz">
      ![Alt text for the image](/images/setupss.png)
    </Frame>
    ...
    <AccordionGroup>
      ...
      <Accordion title="Management Role">
        CA management role is the roles of your server management members. These people will be able to delete punishments, modify people's shift time, and accept LOA Requests.
      </Accordion>
    </AccordionGroup>
  </Step>
  ...
  <Step title="LOA Requests" titleSize="h2">
    ...
    <Frame caption="LOA Requests - ermbot.xyz">
      ![Alt text for the image](/images/loareqss.png)
    </Frame>
  </Step>
  ...
  <Step title="RA Requests" titleSize="h2">
    ...
    <Frame caption="RA Requests - ermbot.xyz">
      ![Alt text for the image](/images/rareqss.png)
    </Frame>
  </Step>
  ...
  <Step title="ROBLOX Punishments" titleSize="h2">
    ...
    <Frame caption="ROBLOX Punishments - ermbot.xyz">
      ![Alt text for the image](/images/robloxpunishmentsss.png)
    </Frame>
  </Step>
  ...
  <Step title="Shift Management" titleSize="h2">
    ...
    <Frame caption="Shift Management - ermbot.xyz">
      ![Alt text for the image](/images/shiftmanagementss.png)
    </Frame>
  </Step>
</Steps>
...
> ERM offers many additional features that aren't part of the setup process. Discover them by using the /config command or exploring our [dashboard!](https://www.ermbot.xyz/)